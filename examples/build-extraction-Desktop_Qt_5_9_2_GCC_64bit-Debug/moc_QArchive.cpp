...
void QArchive::Extractor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Extractor::finished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Extractor::extracted)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Extractor::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Extractor::extracting)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Extractor::status)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Extractor::error)) {
                *result = 4;
                return;
            }
        }
...
void QArchive::Compressor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Compressor::finished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Compressor::compressing)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Compressor::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Compressor::compressed)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Compressor::error)) {
                *result = 3;
                return;
            }
        }
...
QT_MOC_LITERAL(1, 17, 12), // "archiveFiles"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5) // "error"

    },
    "QArchive::Reader\0archiveFiles\0\0error"
};
#undef QT_MOC_LITERAL
...
void QArchive::Reader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->archiveFiles((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QStringList(*)>(_a[2]))); break;
        case 1: _t->error((*reinterpret_cast< short(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Reader::archiveFiles)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QArchive::Reader::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QArchive__Reader.data,
